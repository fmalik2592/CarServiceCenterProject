           ...
           <div class="loginlogo"> <img src="<?php echo base_url() ?>images/logo.jpg" alt=""/> </div>
                ...
                <form method="post" action="<?php echo base_url('login/forgot_password')?>">
                  ...
                  ?>
                    ...
                    <hr>
                    <p class="mt5 mb20">Enter username to get login details on mail.</p>
                
                    <input type="text" class="form-control uname" placeholder="Username" id="exampleInputEmail1" name="emailid" required/>

                    <button class="btn btn-maroon btn-block" type="submit">Get Details</button>
                     </form>
